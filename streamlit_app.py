...
with st.sidebar:
    ...
    # Demo mode toggle (inspired by [citation:3])
...
if not st.session_state.authenticated:
    ...
    3. **AI Resume Builder** - Intelligent resume creation and optimization [citation:3]
    ...
    6. **Career Advisor** - Personalized career path recommendations [citation:5]
...
if __name__ == "__main__":
    ...
    Built with Streamlit & Python | [citation:1][citation:5][citation:7]
    """)
